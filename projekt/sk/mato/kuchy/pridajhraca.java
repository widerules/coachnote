...
public class pridajhraca extends ListActivity {	
	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  piker = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
			      ...
			      Toast.makeText(getApplicationContext(), ((TextView) view).getText()+" bol/a pridany na tento trening",
	...
	setListAdapter(new ArrayAdapter<String>(this, R.layout.add_hrac, hraciMena));
